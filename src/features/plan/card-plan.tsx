    ...
    >
      <div className='ml-[10px] w-[138px] h-fit flex flex-col'>
        ...
        <span className='text-sub text-black font-semibold'>
          {plan.primary_region} / {plan.secondary_region}
        </span>
        <p className='h-[40px] text-main text-black font-bold mt-[4px] break-words overflow-hidden overflow-ellipsis leading-[20px] line-clamp-2'>
          {plan.title}
        </p>
      </div>
